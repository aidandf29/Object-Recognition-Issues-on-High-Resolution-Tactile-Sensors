...
% by using the TactNet-6 approach with 1/2 resolution tactile images.
% =========================================================================
...
TactNet = [
    %input
    imageInputLayer([20 35 1], 'Name', 'Input')
...
images_dir = fullfile('Experiment_IEEE/Images_halfRes_2');
...
augmented_trainingSet = augmentedImageSource([20 35], trainingSet,...
