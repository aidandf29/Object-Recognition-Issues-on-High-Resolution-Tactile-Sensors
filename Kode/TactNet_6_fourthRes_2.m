...
% by using the TactNet-6 approach with 1/8 resolution tactile images.
% =========================================================================
...
TactNet = [
    %input
    imageInputLayer([10 18 1], 'Name', 'Input')
...
images_dir = fullfile('Experiment_IEEE/Images_fourthRes_2');
...
augmented_trainingSet = augmentedImageSource([10 18], trainingSet,...
