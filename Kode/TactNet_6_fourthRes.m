...
% by using the TactNet-6 approach with 1/16 resolution tactile images.
% =========================================================================
...
TactNet = [
    %input
    imageInputLayer([7 13 1], 'Name', 'Input')
...
augmented_trainingSet = augmentedImageSource([7 13], trainingSet,...
